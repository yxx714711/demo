...
public interface SummaryRepository {
     ...
     */
    boolean existsSummary(SummaryCoordinate key) throws IOException;

    /**
     * 读取某 summary 节点
     */
    NodeSummary loadSummary(SummaryCoordinate key) throws IOException;

    /**
     * 原子写 summary 节点（temp 文件 + rename，杜绝中途崩溃致文件残缺）
     */
    void saveSummary(SummaryCoordinate key, NodeSummary summary) throws IOException;
